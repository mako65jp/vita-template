...
import { getActiveAuthPlugin, resetActiveRegistry, setActiveRegistry } from './auth-service';

import { AuthPlugin, AuthPluginRegistry } from '@shared/functions';
...
describe('auth-service', () => {
    ...
    describe('getActiveAuthPlugin', () => {
        ...
        it('registry が未初期化の場合は例外を送出する', () => {
            expect(() => getActiveAuthPlugin('local')).toThrowError(
        ...
        it('未登録プラグインの場合は registry の例外を伝播する', () => {
            ...
            expect(() => getActiveAuthPlugin('unknown')).toThrowError(
        ...
        it('特殊文字を含むプラグイン名を扱える', () => {
            ...
            const result = getActiveAuthPlugin('ldap-test_plugin@v1');
        ...
        it('大文字小文字を区別する', () => {
            ...
            expect(getActiveAuthPlugin('Local')).toBe(plugin);
